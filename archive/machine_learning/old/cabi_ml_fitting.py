...
to_drop = ['rain^2', 'snow^2', 'us_holiday^2', 'nats_single^2', 'nats_double^2', 'dc_bike_event^2']
...
# TODO: take out sin/cos day of year squared and interaction terms
...
# * Take out some polynomial terms
