...
api_key = "" # see Asana ticket for key
lat = 38.894432
lng = -77.013655
...
start_date = datetime.datetime(2018, 2, 17)
...
for daily_data in daily.data:
    ...
    print(precipIntensity, precipIntensityMax, precipType, temperatureHigh, temperatureLow)
